...
homerange %>% 
  ...
  geom_histogram(alpha = 0.7, color = "black", fill = "pink", bins=40)+
...
homerange %>% 
  ...
  geom_histogram(fill = "gray68", alpha = 0.4, color = "black")+
  labs(title = "Distribution of Body Mass")
```
...
homerange %>%
  ggplot(aes(x=log10.hra))+
  geom_histogram(aes(y=after_stat(density), fil="deepskyblue4", alpha=0.4, color="black"))+
